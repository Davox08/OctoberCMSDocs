...
## [AJAX Framework](ajax/introduction.md)

Learn more about the the AJAX framework used by October CMS.

### AJAX

#### [Introduction](ajax/introduction.md)

* [Including the Framework](ajax/introduction.md#including-the-framework)
* [Extra Features](ajax/introduction.md#extra-features)
* [How AJAX Requests Work](ajax/introduction.md#how-ajax-requests-work)
* [Usage Example](ajax/introduction.md#usage-example)

#### [Event Handlers](ajax/handlers.md)

* [AJAX Handlers](ajax/handlers.md#ajax-handlers)
  * [Calling a Handler](ajax/handlers.md#calling-a-handler)
  * [Form Serialization](ajax/handlers.md#form-serialization)
  * [Generic Handler](ajax/handlers.md#generic-handler)
  * [Component Handlers](ajax/handlers.md#component-handlers)
* [Redirects in AJAX Handlers](ajax/handlers.md#redirects-in-ajax-handlers)
* [Returning Data from AJAX Handlers](ajax/handlers.md#returning-data-from-ajax-handlers)
* [Running Code Before Handlers](ajax/handlers.md#running-code-before-handlers)
* [Throwing an AJAX Exception](ajax/handlers.md#throwing-an-ajax-exception)
* [Dispatching Browser Events](ajax/handlers.md#dispatching-browser-events)

#### [Updating Partials](ajax/update-partials.md)

* [Pulling Partial Updates](ajax/update-partials.md#pulling-partial-updates)
  * [Self-Updating Partials](ajax/update-partials.md#self-updating-partials)
  * [Global Partial Updates](ajax/update-partials.md#global-partial-updates)
* [Update Definition](ajax/update-partials.md#update-definition)
  * [Appending and Prepending Content](ajax/update-partials.md#appending-and-prepending-content)
  * [Using Custom HTML Selectors](ajax/update-partials.md#using-custom-html-selectors)
* [Pushing Partial Updates](ajax/update-partials.md#pushing-partial-updates)
* [Passing Variables to Partials](ajax/update-partials.md#passing-variables-to-partials)

#### [Data Attributes API](ajax/attributes-api.md)

* [Usage Examples](ajax/attributes-api.md#usage-examples)

#### [JavaScript API](ajax/javascript-api.md)

* [Usage Examples](ajax/javascript-api.md#usage-examples)
* [Global AJAX Events](ajax/javascript-api.md#global-ajax-events)
* [Usage Examples](ajax/javascript-api.md#usage-examples-2)

#### [Turbo Router](ajax/turbo-router.md)

* [Routing Links](ajax/turbo-router.md#routing-links)
* [Disable Routing](ajax/turbo-router.md#disable-routing)
* [Disable for Specific Links](ajax/turbo-router.md#disable-for-specific-links)
* [Disable Visit Scrolling](ajax/turbo-router.md#disable-visit-scrolling)
* [Persisting Page Elements](ajax/turbo-router.md#persisting-page-elements)
* [Setting a Root Path](ajax/turbo-router.md#setting-a-root-path)
* [Native Error Pages](ajax/turbo-router.md#native-error-pages)
* [Page Caching](ajax/turbo-router.md#page-caching)
  * [Listening for the Cache Event](ajax/turbo-router.md#listening-for-the-cache-event)
  * [Detecting a Cached Page Load](ajax/turbo-router.md#detecting-a-cached-page-load)
  * [Disabling the Cache](ajax/turbo-router.md#disabling-the-cache)
* [Working with JavaScript](ajax/turbo-router.md#working-with-javascript)
  * [Inline Script Elements](ajax/turbo-router.md#inline-script-elements)
  * [Making Controls Idempotent](ajax/turbo-router.md#making-controls-idempotent)
  * [Disposing Controls](ajax/turbo-router.md#disposing-controls)
  * [Pause Rendering](ajax/turbo-router.md#pause-rendering)
* [Global Events](ajax/turbo-router.md#global-events)
* [Usage Examples](ajax/turbo-router.md#usage-examples)
* [Working with Hot Reloading](ajax/turbo-router.md#working-with-hot-reloading)

#### [Hot Controls](ajax/hot-controls.md)

* [Registering an Observable Control](ajax/hot-controls.md#registering-an-observable-control)
* [Initializing a Control](ajax/hot-controls.md#initializing-a-control)
  * [Configuration](ajax/hot-controls.md#configuration)
  * [Child Elements](ajax/hot-controls.md#child-elements)
* [Referencing Other Controls](ajax/hot-controls.md#referencing-other-controls)
* [Working with Events](ajax/hot-controls.md#working-with-events)
  * [Local Events](ajax/hot-controls.md#local-events)
  * [Global Events](ajax/hot-controls.md#global-events)
  * [Dispatching Events](ajax/hot-controls.md#dispatching-events)
* [Usage Examples](ajax/hot-controls.md#usage-examples)
  * [Vanilla JS Example](ajax/hot-controls.md#vanilla-js-example)
  * [Google Maps Example](ajax/hot-controls.md#google-maps-example)
  * [Vue.js Example](ajax/hot-controls.md#vue-js-example)

### Features

#### [Validation](ajax/features/validation.md)

* [Flash Validation](ajax/features/validation.md#flash-validation)
* [Inline Validation](ajax/features/validation.md#inline-validation)
  * [Validating a Single Field](ajax/features/validation.md#validating-a-single-field)
* [Using the Validation Service](ajax/features/validation.md#using-the-validation-service)
  * [Custom Error Messages & Attributes](ajax/features/validation.md#custom-error-messages-attributes)
* [Displaying Error Messages](ajax/features/validation.md#displaying-error-messages)
  * [Displaying Errors with Fields](ajax/features/validation.md#displaying-errors-with-fields)
  * [Displaying Errors with Flash Messages](ajax/features/validation.md#displaying-errors-with-flash-messages)
* [Working with JavaScript](ajax/features/validation.md#working-with-javascript)
* [Complete Usage Example](ajax/features/validation.md#complete-usage-example)

#### [File Uploads](ajax/features/uploads.md)

* [Uploading Files](ajax/features/uploads.md#uploading-files)
  * [Uploading Multiple Files](ajax/features/uploads.md#uploading-multiple-files)
  * [Validating File Uploads](ajax/features/uploads.md#validating-file-uploads)
* [Uploading to Models](ajax/features/uploads.md#uploading-to-models)

#### [File Downloads](ajax/features/downloads.md)

* [Download Buttons](ajax/features/downloads.md#download-buttons)
* [Download Responses](ajax/features/downloads.md#download-responses)
* [Usage Example](ajax/features/downloads.md#usage-example)

#### [Loading Indicators](ajax/features/loaders.md)

* [Progress Bar](ajax/features/loaders.md#progress-bar)
* [Loading Button](ajax/features/loaders.md#loading-button)
* [Toggling Elements](ajax/features/loaders.md#toggling-elements)
  * [Detecting Global Requests](ajax/features/loaders.md#detecting-global-requests)
  * [Targeting Specific Handlers](ajax/features/loaders.md#targeting-specific-handlers)
* [Working with JavaScript](ajax/features/loaders.md#working-with-javascript)

#### [Flash Messages](ajax/features/flash-messages.md)

* [Built-in Flash Messages](ajax/features/flash-messages.md#built-in-flash-messages)
  * [Loading Flash Message](ajax/features/flash-messages.md#loading-flash-message)
  * [Styling the Flash Message](ajax/features/flash-messages.md#styling-the-flash-message)
* [Custom Flash Messages](ajax/features/flash-messages.md#custom-flash-messages)
* [Working with JavaScript](ajax/features/flash-messages.md#working-with-javascript)

#### [Pagination](ajax/features/pagination.md)

* [Paginating Data](ajax/features/pagination.md#paginating-data)
  * [Multiple Pagination Instances](ajax/features/pagination.md#multiple-pagination-instances)
  * [Using Custom Pagination Markup](ajax/features/pagination.md#using-custom-pagination-markup)
* [AJAX Pagination](ajax/features/pagination.md#ajax-pagination)
* [Load More Pagination](ajax/features/pagination.md#load-more-pagination)

#### [Redirects](ajax/features/redirects.md)

* [Redirecting to a CMS Page](ajax/features/redirects.md#redirecting-to-a-cms-page)
* [Redirects in Twig](ajax/features/redirects.md#redirects-in-twig)
* [Redirects in AJAX](ajax/features/redirects.md#redirects-in-ajax)

#### [Polling](ajax/features/polling.md)

* [Lazy Loading Requests](ajax/features/polling.md#lazy-loading-requests)
* [Polling Requests](ajax/features/polling.md#polling-requests)
* [Lazy Loading Partials](ajax/features/polling.md#lazy-loading-partials)

#### [Modals](ajax/features/modals.md)

* [Modal Content](ajax/features/modals.md#modal-content)
* [Modal Trigger](ajax/features/modals.md#modal-trigger)
* [Modal Container](ajax/features/modals.md#modal-container)
